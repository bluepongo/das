...
func initDebugDBMessage() {
	...
	message.Messages[DebugMetadataGetAppsByDBID] = config.NewErrMessage(message.DefaultMessageHeader, DebugMetadataGetAppsByDBID, "metadata: get app id list completed. message: %s")
	message.Messages[DebugMetadataGetMySQLClusterByDBID] = config.NewErrMessage(message.DefaultMessageHeader, DebugMetadataGetMySQLClusterByDBID, "metadata: get mysql cluster by id completed. message: %s")
	message.Messages[DebugMetadataGetAppUsersByDBID] = config.NewErrMessage(message.DefaultMessageHeader, DebugMetadataGetAppUsersByDBID, "metadata: get app users by id completed. message: %s")
	message.Messages[DebugMetadataGetUsersByDBID] = config.NewErrMessage(message.DefaultMessageHeader, DebugMetadataGetUsersByDBID, "metadata: get users by id completed. message: %s")
	message.Messages[DebugMetadataGetAllUsersByDBID] = config.NewErrMessage(message.DefaultMessageHeader, DebugMetadataGetAllUsersByDBID, "metadata: get all users by id completed. message: %s")
