...
func initInfoTableMessage() {
	...
	message.Messages[InfoMetadataGetStatisticsByHostInfoAndDBNameAndTableName] = config.NewErrMessage(message.DefaultMessageHeader, InfoMetadataGetStatisticsByHostInfoAndDBNameAndTableName, "metadata: get tables by host info and db name and table name completed. host_ip: %s, port_num: %d, db_name: %s, table_name: %s")
	message.Messages[InfoMetadataAnalyzeTableByDBIDAndTableName] = config.NewErrMessage(message.DefaultMessageHeader, InfoMetadataAnalyzeTableByDBIDAndTableName, "metadata: analyze table by db id and table name completed. db_id: %d, table_name: %s")
	message.Messages[InfoMetadataAnalyzeTableByHostInfoAndDBNameAndTableName] = config.NewErrMessage(message.DefaultMessageHeader, InfoMetadataAnalyzeTableByHostInfoAndDBNameAndTableName, "metadata: analyze table by host info and db name and table name completed. host_ip: %s, port_num: %d, db_name: %s, table_name: %s")
}
...
func initErrorTableMessage() {
	...
	message.Messages[ErrMetadataGetStatisticsByDBIDAndTableName] = config.NewErrMessage(message.DefaultMessageHeader, ErrMetadataGetStatisticsByDBIDAndTableName, "metadata: get statistics by db id and table name failed. db_id: %d, table_name: %s")
	message.Messages[ErrMetadataGetStatisticsByHostInfoAndDBNameAndTableName] = config.NewErrMessage(message.DefaultMessageHeader, ErrMetadataGetStatisticsByHostInfoAndDBNameAndTableName, "metadata: get statistics by host info and db name and table name failed. host_ip: %s, port_num: %d, db_name: %s, table_name: %s")
	message.Messages[ErrMetadataAnalyzeTableByDBIDAndTableName] = config.NewErrMessage(message.DefaultMessageHeader, ErrMetadataAnalyzeTableByDBIDAndTableName, "metadata: analyze table by db id and table name failed. db_id: %d, table_name: %s")
	message.Messages[ErrMetadataAnalyzeTableByHostInfoAndDBNameAndTableName] = config.NewErrMessage(message.DefaultMessageHeader, ErrMetadataAnalyzeTableByHostInfoAndDBNameAndTableName, "metadata: analyze table by host info and db name and table name failed. host_ip: %s, port_num: %d, db_name: %s, table_name: %s")
