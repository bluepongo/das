...
func RegisterMetadata(group *gin.RouterGroup) {
	metadataGroup := group.Group("/metadata")
	{
		...
		// resource group
		metadataGroup.GET("/resource-group", metadata.GetResourceGroup)
		metadataGroup.GET("/resource-group/get", metadata.GetResourceGroupByID)
		metadataGroup.GET("/resource-group/group-uuid", metadata.GetResourceGroupByGroupUUID)
		metadataGroup.GET("/resource-group/resource-role/id", metadata.GetResourceRolesByGroupID)
		metadataGroup.GET("/resource-group/mysql-cluster/id", metadata.GetMySQLClustersByGroupID)
		metadataGroup.GET("/resource-group/mysql-server/id", metadata.GetMySQLServersByGroupID)
		metadataGroup.GET("/resource-group/middleware-cluster/id", metadata.GetMiddlewareClustersByGroupID)
		metadataGroup.GET("/resource-group/middleware-server/id", metadata.GetMiddlewareServersByGroupID)
		metadataGroup.GET("/resource-group/user/id", metadata.GetUsersByGroupID)
		metadataGroup.GET("/resource-group/das-admin/id", metadata.GetDASAdminUsersByGroupID)
		metadataGroup.GET("/resource-group/resource-role/group-uuid", metadata.GetResourceRolesByGroupUUID)
		metadataGroup.GET("/resource-group/mysql-cluster/group-uuid", metadata.GetMySQLClustersByGroupUUID)
		metadataGroup.GET("/resource-group/mysql-server/group-uuid", metadata.GetMySQLServersByGroupUUID)
		metadataGroup.GET("/resource-group/middleware-cluster/group-uuid", metadata.GetMiddlewareClustersByGroupUUID)
		metadataGroup.GET("/resource-group/middleware-server/group-uuid", metadata.GetMiddlewareServersByGroupUUID)
		metadataGroup.GET("/resource-group/user/group-uuid", metadata.GetUsersByGroupUUID)
		metadataGroup.GET("/resource-group/das-admin/group-uuid", metadata.GetDASAdminUsersByGroupUUID)
		metadataGroup.POST("/resource-group", metadata.AddResourceGroup)
