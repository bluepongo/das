CREATE TABLE `t_meta_app_info` (
  ...
  `owner_group` varchar(100) DEFAULT NULL COMMENT '应用系统主要负责人ID列表',
...
CREATE TABLE `t_meta_db_info` (
  ...
  `owner_group` varchar(100) DEFAULT NULL COMMENT '数据库主要负责人ID列表',
...
CREATE TABLE `t_meta_middleware_cluster_info` (
  ...
  `owner_group` varchar(100) DEFAULT NULL COMMENT '中间件主要负责人ID列表',
  `env_id` int(11) NOT NULL COMMENT '环境: 1-online, 2-rel, 3-uat, 4-sit, 5-pt, 6-dev',
  `del_flag` tinyint(4) NOT NULL DEFAULT '0' COMMENT '删除标记: 0-未删除, 1-已删除',
  `create_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `last_update_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '最后更新时间',
...
CREATE TABLE `t_meta_mysql_cluster_info` (
  ...
  `owner_group` varchar(100) DEFAULT NULL COMMENT '数据库集群主要负责人ID列表',
  `env_id` int(11) NOT NULL COMMENT '环境: 1-online, 2-rel, 3-uat, 4-sit, 5-pt, 6-dev',
  `del_flag` tinyint(4) NOT NULL DEFAULT '0' COMMENT '删除标记: 0-未删除, 1-已删除',
  `create_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `last_update_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '最后更新时间',
...
CREATE TABLE `t_meta_mysql_server_info` (
  ...
  `server_name` varchar(100) DEFAULT NULL COMMENT '数据库实例名称',
  `service_name` varchar(100) DEFAULT NULL COMMENT '数据库服务名称',
  `host_ip` varchar(100) NOT NULL COMMENT '服务器IP',
  `port_num` int(11) NOT NULL COMMENT '端口',
  `deployment_type` tinyint(4) DEFAULT NULL COMMENT '部署方式: 1-容器, 2-物理机, 3-虚拟机',
